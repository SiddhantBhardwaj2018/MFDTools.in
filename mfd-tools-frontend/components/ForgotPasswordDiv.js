    ...
    authService
      ...
      .then((res) => {
        if (res.data.status == "success") {
          setIsLoading(false);
          setIsError("Please check your email for reset password link");
        } else {
          setIsLoading(false);
          setIsError("Please enter your registered email address");
        }
      })
      .catch((err) => {
        setIsLoading(false);
        setIsError("Sorry ! There has been an error !");
      });
  };
