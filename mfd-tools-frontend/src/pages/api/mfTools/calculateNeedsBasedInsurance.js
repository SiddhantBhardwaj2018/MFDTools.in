...
const calculateNeedsBasedInsurance = async (req, res) => {
  ...
  if (req.method === "POST") {
    ...
    const apiRes = await fetch(`${API_URL}/api/mfTools/needBasedApproach`, {
      method: "POST",
      headers: {
...
export default calculateNeedsBasedInsurance;
