...
const getDecliningNavSensexPerformance = async (req, res) => {
  ...
  if (req.method === "POST") {
    ...
    const apiRes = await fetch(
      `${API_URL}/api/mfTools/getDecliningNavSensexPerformance`,
      {
        method: "POST",
        headers: {
...
export default getDecliningNavSensexPerformance;
