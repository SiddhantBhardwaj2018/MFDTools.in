...
const getWeeklyBestAndWorstMFSchemePerformers = async (req, res) => {
  ...
  if (req.method === "POST") {
    ...
    const apiRes = await fetch(
      `${API_URL}/api/mfTools/getWeeklyBestAndWorstMFSchemePerformers`,
      {
        method: "POST",
        headers: {
...
export default getWeeklyBestAndWorstMFSchemePerformers;
