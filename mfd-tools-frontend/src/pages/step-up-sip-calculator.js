...
export default function stepUpSipCalculator() {
  ...
  const onSubmitStepUpSipCalculator = (e) => {
    e.preventDefault();
    if (
      timePeriod.length > 0 &&
      amount.length > 0 &&
      ...
      <div style={{ margin: "0 8%" }}>
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 flex justify-center mt-4">
            <button
              type="submit"
              onClick={onSubmitStepUpSipCalculator}
                ...
                <thead className="text-md text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  <tr>
                    <th scope="col" className="px-6 py-3">
                      Total Amount Invested (SIP Without Increment) (₹){" "}
                    </th>
                    <th scope="col" className="px-6 py-3">
                      {totalAmountInvestedWithoutIncrement}
                    </th>
                  ...
                  <tr>
                    <th scope="col" className="px-6 py-3">
                      Total Maturity Amount (Without Increment) (₹){" "}
                    </th>
                    <th scope="col" className="px-6 py-3">
                      {totalMaturityAmtWithoutIncrement}
                    </th>
                  ...
                  <tr>
                    <th scope="col" className="px-6 py-3">
                      Investment Growth (Without Increment) (₹){" "}
                    </th>
                    <th scope="col" className="px-6 py-3">
                      {investmentGrowthWithoutIncrement}
                    </th>
                  ...
                  <tr>
                    <th scope="col" className="px-6 py-3">
                      Total Amount Invested (SIP + Increment) (₹){" "}
                    </th>
                    <th scope="col" className="px-6 py-3">
                      {totalAmountInvested}
                    </th>
